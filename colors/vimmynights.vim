...
let colors_name = "vimmynifghts"

hi Normal		guifg=#c0c0c0 	guibg=#000000						ctermfg=gray 		ctermbg=black
hi ErrorMsg		guifg=#ffffff 	guibg=#287eff						ctermfg=white 		ctermbg=lightblue
hi Visual		guifg=darkgray 	guibg=white gui=reverse				ctermfg=darkgray 	ctermbg=white cterm=reverse
...
hi StatusLine	guifg=blue 	guibg=lightgray gui=bold 	ctermfg=blue 	ctermbg=lightgray term=none cterm=bold
...
hi PmenuSel 	guifg=darkgray guibg=white ctermfg=darkgray ctermbg=white
